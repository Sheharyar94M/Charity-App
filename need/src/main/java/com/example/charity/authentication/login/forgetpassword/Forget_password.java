package com.example.charity.authentication.login.forgetpassword;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        passwordBinding.continueButtonPhone.setOnClickListener(v -> auth.sendPasswordResetEmail(
                ...
                .addOnFailureListener(e -> {
                    ...
                    //Snack bar
                    View parentLayout = findViewById(android.R.id.content);
                    Snackbar snackbar = Snackbar.make(parentLayout, "Unable to send reset link to email! Check your internet connection!", Snackbar.LENGTH_LONG);
                    snackbar.setAction("Close", view -> snackbar.dismiss());
                    snackbar.setActionTextColor(getResources().getColor(android.R.color.holo_red_light));
                    snackbar.show();
